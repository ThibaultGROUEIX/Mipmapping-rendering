...
void init (const char * modelFilename) {
  ...
  try {
    ...
    glProgram->Program::setUniform1f("roughness_shader", 0.3);
    glProgram->Program::setUniform1f("coeffFresnel", 0.04);
    glProgram->Program::setUniform3f("lightPos", 0.5,0.5,0.5);
    glProgram->Program::setUniform3f("matAlbedo",0.5,0.5,0.5);
...
void drawScene () {
  ...
  {  
    ...
    glProgram->Program::setUniform3f("lightPos", cos(rotateLightAngle),0.5,sin(rotateLightAngle));
  }
...
void key (unsigned char keyPressed, int x, int y) {
  ...
  case '+' :
    {
    GLfloat panams;
    glProgram->Program::getUniform("roughness_shader", &panams);
    panams  = -max(-1.0, -panams-0.05);
    glProgram->Program::setUniform1f("roughness_shader", panams);
  ...
  {
    GLfloat panams;
    glProgram->Program::getUniform("coeffFresnel", &panams);
    panams  = max(0.0, panams-0.05);
    std::cout << panams;
    glProgram->Program::setUniform1f("coeffFresnel", panams);
